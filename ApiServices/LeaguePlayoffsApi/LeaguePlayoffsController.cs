...
/*
    ...
    public async Task<ActionResult<Dictionary<string, object>>> ProcessUserSubmittedWholeSchedule(string LeaguePlayoffId, [FromForm] IFormFile PlayoffFormat, [FromForm] IFormCollection reqBody) {
        try {
            var playoffs = (LeaguePlayoffs) await _leagueService.GetData("leaguePlayoffConfig", LeaguePlayoffId);
            if (playoffs == null) {
                return BadRequest();
    ...
    */
    ...
    public async Task<ActionResult> CreateWholePlayoffFormatBracket(string LeaguePlayoffId, Dictionary<string, object> reqBody) {
        try {
            ...
            await _kafkaProducer.ProduceMessageAsync("CreateWholePlayoffBracket", JsonConvert.SerializeObject(leagueBracket), LeaguePlayoffId);
    ...
    */
    ...
    public async Task<ActionResult> CreateDivisionBasedBracket(string LeaguePlayoffId, Dictionary<string, object> reqBody) {
        try {
            ...
            await _kafkaProducer.ProduceMessageAsync("CreateDivisionBasedBracket", JsonConvert.SerializeObject(leagueBracket), LeaguePlayoffId);
    ...
    public async Task<ActionResult<Dictionary<string, object>>> UpdatePlayoffBracket(string LeaguePlayoffId, Dictionary<string, object> reqBody) {
        try {
            ...
            await _kafkaProducer.ProduceMessageAsync("UpdatePlayoffBracket", JsonConvert.SerializeObject(tempBracket), LeaguePlayoffId);
    ...
    public async Task<ActionResult> AddPlayoffMatchupDate(string LeaguePlayoffId, Dictionary<string, string> reqBody) {
        try {
            ...
            await _kafkaProducer.ProduceMessageAsync("AddGameToMatchup", reqBody["GameId"].ToString(), LeaguePlayoffId);
    ...
    public async Task<ActionResult> SetupFinalRounds(string LeaguePlayoffId) {
        try {
            ...
            await _kafkaProducer.ProduceMessageAsync("SetupFinalRounds", JsonConvert.SerializeObject(leagueBracket), LeaguePlayoffId);
    ...
    public async Task<ActionResult<Dictionary<string, object>>> UpdateFinalRounds(string LeaguePlayoffId, Dictionary<string, object> reqBody) {
        try {
            ...
            await _kafkaProducer.ProduceMessageAsync("UpdateFinalRounds", JsonConvert.SerializeObject(leagueBracket), LeaguePlayoffId);
    ...
    public async Task<ActionResult> UpdateFinalRoundMatchupWithGameId(string LeaguePlayoffsId, Dictionary<string, object> reqBody) {
        try {
            ...
            await _kafkaProducer.ProduceMessageAsync("AddGameWithFinalRoundMatch", JsonConvert.SerializeObject(leagueBracket), LeaguePlayoffsId);
...
/*
   ...
   public async Task<ActionResult> CreateUserBasedBracket(string LeaguePlayoffsId, Dictionary<string, object> reqBody) {
    try {
        ...
        await _kafkaProducer.ProduceMessageAsync("ConstructUserDefinedBracket", JsonConvert.SerializeObject(leagueBracket), LeaguePlayoffsId);
   ...
   public async Task<ActionResult> UpdateMatchupSeries(string LeaguePlayoffId, Dictionary<string, object> reqBody) {
        try {
            ...
            await _kafkaProducer.ProduceMessageAsync("UpdateMatchupSeries", JsonConvert.SerializeObject(leagueBracket), LeaguePlayoffId);
